...
1. An Oracle Cloud account. Sign up for an Always Free tire account at at link:http://oracle.com/cloud/free[].
2. A resource compartment. It's recommended to use a different compartment that the default `root`.
